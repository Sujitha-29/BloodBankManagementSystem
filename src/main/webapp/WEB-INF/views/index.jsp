...
.hero-image {
	/* background-image:
        url("https://images.hdqwalls.https://www.istockphoto.com/photos/blood-donation.jpg");
    height: 768px;
    width: 1366px;
    ...
    position: relative; */
	background-image: url('istockphoto.com/photos/blood-donation.jpg');
	background-repeat: no-repeat;
	...
	<div>
		...
		<div>
			<a href="/admin/addadminform">Add Admin</a>
		</div>
		<div>
